...
INSERT INTO cam_ket(so_tien,ngay_nhan_nuoi ,trang_thai ,ma_tre_em ,ma_nguoi_nuoi)
VALUES 
(500000,'2023-08-28',1,8,1);

insert into lich_su_giao_dich(ngay_giao_dich, noi_dung_giao_dich, ma_cam_ket)
values
('2023-09-01', "NGUYEN THI HUONG ct NE1",1),
('2023-09-01', "TRAN VAN DUC ct NE2",2),
('2023-09-01', "le thi mai ct NE3",3),
('2023-10-01', "NGUYEN THI HUONG ct NE1",1),
('2023-10-01', "le thi mai ct NE3",3);
...
select sum(ifnull((ck.so_tien),0))
from lich_su_giao_dich gd
join cam_ket ck on gd.ma_cam_ket = ck.ma_cam_ket
where month(gd.ngay_giao_dich) = 9 and year(gd.ngay_giao_dich) = 2023
group by month(gd.ngay_giao_dich);
