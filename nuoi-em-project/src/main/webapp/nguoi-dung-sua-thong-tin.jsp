...
<body>
<div class="header">
    <div class="content">Sửa thông tin người dùng</div>
</div>
<div class="container">
    <div class="main">
        <form action="nguoi-nuoi?action=sua1&maNguoiNuoi=${maNguoiNuoi}&maTaiKhoan=${maNguoiNuoi}" method="post" name="form-1"
              id="form-1" onsubmit="return(validate());">
            <div class="form-group mb-1 mt-3">
                <label for="tenNguoiNuoi" class="form-label">Họ và tên</label>
                <input id="tenNguoiNuoi" name="tenNguoiNuoi" value="${tenNguoiNuoi}" type="text" class="form-control"
                       required>
            ...
            <button id="btn" type="submit" class="btn btn-success mt-2">Xác nhận</button>
            <div class="log-in mt-2 mb-2">
                <button id="login" type="button" class="btn btn-primary">
                    <a href="#">Quay lại</a></button>
            </div>
        </form>
    </div>
</div>
