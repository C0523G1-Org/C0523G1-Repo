                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Sửa thông tin trẻ em</strong>
                                </div>
                                <div class="card-body card-block">
                                    <form action="tre-em?action=sua" method="post"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="tenTreEm" required name="tenTreEm"
                                                       class="form-control" value="${treEm.tenTreEm}">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col col-md-9">
                                                ...
                                                <c:set var="luaChon" value="${treEm.gioiTinh}"/>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input id="ngaySinh" name="ngaySinh" class="form-control"
                                                       required type="date" value="${treEm.ngaySinh}">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="moTa" id="textarea-input" rows="9"
                                                          class="form-control" value="${treEm.moTa}"></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
...
<%--                                            chưa biết làm hiển thị khu vuc đã chọn--%>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="file" id="hinhAnh" name="hinhAnh"
                                                       class="form-control-file" value="${treEm.hinhAnh}">
                                            </div>
                                        </div>
                                        <div class="row form-group">
