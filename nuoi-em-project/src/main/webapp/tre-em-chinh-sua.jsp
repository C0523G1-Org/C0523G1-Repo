...
<head>
    ...
    <!-- Title Page-->
    <title>Chỉnh sửa thông tin trẻ em</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Chỉnh sửa trẻ em</strong>
                                </div>
                                    ...
                                    <form method="post"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="tenTreEm" value="${treEm.getTenTreEm()}" required
                                                       name="tenTreEm"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col col-md-9">
                                                <div class="form-check-inline form-check">
                                                    ...
                                                    <c:if test="${treEm.getGioiTinh() == 1}">
                                                        <label class="form-check-label ">
                                                            <input value="${1}" type="radio" name="gioiTinh"
                                                                   required checked class="form-check-input">Nam
                                                        </label>
                                                        <label class="form-check-label ">
                                                            <input value="${0}" type="radio" name="gioiTinh"
                                                                   class="form-check-input" required>Nữ
                                                        </label>
                                                    </c:if>
                                                    <c:if test="${treEm.getGioiTinh() == 0}">
                                                        <label class="form-check-label ">
                                                        ...
                                                        <label class="form-check-label ">
                                                            <input value="${0}" type="radio" name="gioiTinh"
                                                                   class="form-check-input" required checked>Nữ
                                                        </label>
                                                    </c:if>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input value="${treEm.getNgaySinh()}" id="ngaySinh" name="ngaySinh"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="moTa" id="txtMoTa" rows="9"
                                                          class="form-control">${treEm.getMoTa()}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                ...
                                                <select name="maKhuVuc" id="maKhuVuc" class="form-control">
                                                    ...
                                                    <c:forEach var="k" items="${khuVuc}">
                                                        <option value="${k.getMaKhuVuc()}"
                                                                <c:if test="${k.getMaKhuVuc() == treEm.getMaKhuVuc()}">
                                                                    selected
                                                                </c:if>
                                                        >${k.getTenKhuVuc()}
                                                        </option>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="maNguoiGiamHo" id="maNguoiGiamHo" class="form-control">
                                                    <option disabled selected>Chọn người giám hộ</option>
                                                    <c:forEach var="ngh" items="${nguoiGiamHo}">
                                                        <option value="${ngh.getMaNguoiGiamHo()}"
                                                                <c:if test="${ngh.getMaNguoiGiamHo() == treEm.getMaNguoiGiamHo()}">
                                                                    selected
                                                                </c:if>
