                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Cập nhật cam kết</strong>
                                </div>
                                <div class="card-body card-block">
                                    <form action="cam-ket?action=sua" method="post"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="soTien" required name="soTien"
                                                       class="form-control" value="${camKet.soTien}">
                                            </div>
                                        </div>
                                        <div class=" row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input readonly id="ngayNhanNuoi" name="ngayNhanNuoi"
                                                       class="form-control"
                                                       required type="date" value="${camKet.ngayNhanNuoi}">
                                            </div>
                                        </div>
                                        <div class=" row form-group">
                                            <div class="col col-md-3">
                                                <label for="trangThai" class=" form-control-label">Trạng
                                                    Thái</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input readonly type="text" id="trangThai" required name="trangThai"
                                                       class="form-control" value="${camKet.trangThai}">
                                            </div>
                                        </div>
                                        <div class=" row form-group">
                                            <div class="col col-md-3">
                                                <label for="maTreEm" class=" form-control-label">Trẻ
                                                    Em</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="maNguoiNuoi" class=" form-control-label">Người
                                                    Nuôi</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input readonly type="text" id="maNguoiNuoi" required name="maNguoiNuoi"
                                                       class="form-control" value="${camKet.maNguoiNuoi}">
                                            </div>
                                        </div>
                                        <div class="row form-group">
