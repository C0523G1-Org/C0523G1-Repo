...
import com.example.nuoiemproject.cam_ket.service.CamKetService;
...
public class CamKetServlet extends HttpServlet {
    ...
    private void hienThiDanhSach(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/danh-sach-cam-ket.jsp");
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
            throw new RuntimeException(e);
    ...
    private void hienThiThem(HttpServletRequest request, HttpServletResponse response) {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/them-moi-cam-ket.jsp");
        try {
            dispatcher.forward(request, response);
        } catch (ServletException e) {
            throw new RuntimeException(e);
